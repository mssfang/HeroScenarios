...
public class TextModeration {
    ...
    private static String TextFile = "C:\\Users\\shafang\\Desktop\\demo.txt";



    static void execute(ContentModeratorClientImpl client) throws IOException {

    	System.out.println("text file directory == " + TextFile);
    ...
    static void execute(ContentModeratorClientImpl client, String text) throws IOException {
